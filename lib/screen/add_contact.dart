                  ...
                  TextButton(
                      ...
                      onPressed: () async {
                        ...
                        if (_validateImage == false &&
                          ...
                          var result = await _contactService.saveContact(_user);
                          Navigator.pop(context, result);
                        }

                        if (_validateImage == true) {
                          _showSuccessSnackBar('Image Field Can\'t Be Empty');
                        }
                      },
